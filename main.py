...
#--------------------------------------------
#prueba de conexion entre mongo y el server

import pymongo
import certifi

ca = certifi.where()
client = pymongo.MongoClient("mongodb+srv://Admin:QmTSTEQ2YPqH0Vut@cluster0.tctqzal.mongodb.net/?retryWrites=true&w=majority")
db = client.test
...
#codigo de pruebas iniciales de servidor
